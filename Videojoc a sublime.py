...
info_imatge = pygame.image.load("Grafics/info_2.png").convert_alpha()
tenda_imatge = pygame.image.load("Grafics/tenda_2.png").convert_alpha()
...
pausa_imatge = pygame.image.load("Grafics/pausa_2.png").convert_alpha()
...
def info():
    ...
    diferencia_max = (pantalla_alçada-24 -(text.get_height()*2.6*4.8 +text2.get_height()*5-10+100+195))
    alçada = (pantalla_alçada*0.05-5-7+pantalla_alçada*0.92)+diferencia_max-pantalla_alçada*0.05
    scroll_relatiu = 1
    if alçada<pantalla_alçada/5:
        diferencia_max /=2
        scroll_relatiu = 2 
        alçada = (pantalla_alçada*0.05-5-7+pantalla_alçada*0.92)+diferencia_max-pantalla_alçada*0.05
        diferencia_max *=2
    ...
    while True:
        ...
        rectangle_scroll_2.center -= pygame.math.Vector2(0,diferencia/scroll_relatiu)
        color =(19,64,132)
        if click_2:
